...
This project is about reviewing one project to get familiar with code review
...
- [Live Demo Link](https://github.com/TiteLunda/Project_review)
...
Use git clone command(https://github.com/TiteLunda/Project_review.git) 
